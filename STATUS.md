...
## 🦉 Last Checked: 2026-02-05 12:31:24 UTC
...
### 🧠 Memory Usage (free -h)
```
Mem:          7.8Gi       834Mi       539Mi       1.0Mi       6.4Gi       6.6Gi
```

### 📈 Uptime & Load Average
```
 12:31:24 up 3 days,  1:17,  1 user,  load average: 0.00, 0.00, 0.00
```
...
│ Gateway         │ local · ws://127.0.0.1:18789 (local loopback) · reachable 57ms · auth token · openclaw (192.168.  │
...
│ agent:main:cron:d6379119-aa72-4…                         │ direct │ 3h ago   │ openrouter/auto     │ 14k/128k (11%) │
│ agent:main:cron:e07e4931-0ff3-4…                         │ direct │ 3h ago   │ openrouter/auto     │ 13k/128k (10%) │
