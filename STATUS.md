...
## 🦉 Last Checked: 2026-02-04 14:02:34 UTC
...
### 🧠 Memory Usage (free -h)
```
Mem:          7.8Gi       831Mi       503Mi       1.0Mi       6.5Gi       6.6Gi
```

### 📈 Uptime & Load Average
```
 14:02:34 up 2 days,  2:48,  1 user,  load average: 0.08, 0.02, 0.01
```
...
│ Gateway         │ local · ws://127.0.0.1:18789 (local loopback) · reachable 61ms · auth token · openclaw (192.168.  │
...
├──────────────────────────────────────────────────────────┼────────┼──────────┼─────────────────────┼────────────────┤
│ agent:main:main                                          │ direct │ just now │ openrouter/auto     │ 28k/128k (22%) │
...
│ agent:main:subagent:69adda44-fb…                         │ direct │ 28h ago  │ gemini-flash-latest │ 12k/1049k (1%) │
